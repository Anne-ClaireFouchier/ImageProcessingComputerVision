...
int main(int argc, char ** argv)
{
	...
	string dataset_path = "/home/luni/eclipse-workspace//dataset2012lite/dataset"; //SET THIS DIRECTORY according to your download
	string dataset_cat[1] = {"dynamicBackground"}; // baseline, shadow, dynamicBackground
	//string baseline_seq[4] = {"highway","office","pedestrians","PETS2006"};
	//string baseline_seq[6] = {"backdoor","bungalows","busStation","cubicle", "copyMachine", "peopleInShade"};
...
//
//	string dataset_path = "/home/luni/eclipse-workspace/AVSASlidesVideos_dataset"; //SET THIS DIRECTORY according to your download
//	string dataset_cat[1] = {"foregroundSeg"};
//	string baseline_seq[1] = {"pedestrians.avi"};//, "empty_office.avi","stationary_objects.avi","eps_hotstart.avi","eps_shadows.avi"};
...
// if (argc==3)	{input=argv[3]);}
	...
	string project_root_path = "/home/luni/eclipse-workspace/"; //SET THIS DIRECTORY according to your project
	string project_name = "Lab1.0AVSA2020_2"; // project exe name
	string results_path = project_root_path + "/" + project_name + "/results1";
...
//			namedWindow("ForeGround Mask"); // final fgmask
			...
			double tau = 60; // to set ... //Lab1.1.1-3
			double alpha=0.07; // to set ... //Lab1.1.2-3
